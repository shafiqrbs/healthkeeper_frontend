...
import { Button, Flex, Grid, Box, ScrollArea, Text, Title, Stack, Tooltip, rem } from "@mantine/core";
import { useTranslation } from "react-i18next";
import { IconDeviceFloppy, IconCalendar, IconCheck } from "@tabler/icons-react";
...
function _InhouseForm(Props) {
	...
	useEffect(() => {
		setIssueDate(batchData.issue_date ? new Date(batchData.issue_date) : null);
		setReceiveDate(batchData.receive_date ? new Date(batchData.receive_date) : null);
	}, []);
							...
							<Box bg={"white"}>
								...
								>
									<Grid>
										<Grid.Col span={6}>
											<Title order={6} pt={"6"}>
												{t("ManageProductionInhouseBatch")}
											</Title>
										</Grid.Col>
										<Grid.Col span={6}>
