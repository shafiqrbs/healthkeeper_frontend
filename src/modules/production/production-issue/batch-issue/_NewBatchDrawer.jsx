...
import { ActionIcon, Box, ScrollArea, Drawer, Flex, Button, Progress } from "@mantine/core";
...
export default function _NewBatchDrawer(props) {
	...
	return (
		<>
			<Drawer.Root opened={batchDrawer} position="right" onClose={closeDrawer} size={"100%"}>
				<Drawer.Overlay />
				<Drawer.Content>
					<ScrollArea h={height + 100} scrollbarSize={2} type="never" bg={"gray.1"}>
						...
						<Box ml={2} mr={2} mb={0}>
							{batchId && <InhouseIndex batchId={batchId} />}
						</Box>
					</ScrollArea>
				</Drawer.Content>
			</Drawer.Root>
