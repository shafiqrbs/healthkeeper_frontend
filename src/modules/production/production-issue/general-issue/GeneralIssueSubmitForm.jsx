...
export default function GeneralIssueSubmitForm(props) {
	const { isSMSActive, currencySymbol, domainId, isZeroReceiveAllow, setLoadCardProducts, loadCardProducts } = props;
				...
				<Box>
					<SimpleGrid cols={{ base: 1, md: 3 }} mt={"2"} spacing="xs" mb={"xs"}>
						<Card
							shadow="md"
							radius="4"
							className={`${classes.card} ${genericClass.genericBackground}`}
							padding="xs"
						>
							<Box>
								<SelectForm
