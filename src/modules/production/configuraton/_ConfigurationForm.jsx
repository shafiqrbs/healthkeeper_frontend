...
function _ConfigurationForm() {
	...
	const [productionProcedureId, setProductionProcedureId] = useState(
		showEntityData.production_procedure_id ? showEntityData.production_procedure_id.toString() : null
	);
	const [consumptionMethodId, setConsumptionMethodId] = useState(
		showEntityData.consumption_method_id ? showEntityData.consumption_method_id.toString() : null
	);
	...
	const form = useForm({
		initialValues: {
			production_procedure_id: showEntityData.production_procedure_id
				? showEntityData.production_procedure_id
				: "",
