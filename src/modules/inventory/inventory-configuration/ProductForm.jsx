...
function ProductForm({ height, config_product, id, fetchDomainConfig }) {
		...
		return (
			<Box mt={"xs"}>
				<Grid
					...
					onClick={() => form.setFieldValue(name, form.values[name] === 1 ? 0 : 1)}
				>
					...
					<Grid.Col span={1}>
						<Checkbox
							...
							onChange={(event) => form.setFieldValue(name, event.currentTarget.checked ? 1 : 0)}
							styles={(theme) => ({
								input: {
									borderColor: "red",
								},
				...
				<Box pt={"xs"} pl={"xs"} pb={"sm"}>
					...
					<Box>
						<InputCheckboxForm
							...
							field={"is_product_gallery"}
							name={"is_product_gallery"}
						/>
					</Box>
					<Box>
						<InputCheckboxForm form={form} label={t("SKU")} field={"is_sku"} name={"is_sku"} />
					</Box>
					<Center>
					...
					<Box>
						<InputCheckboxForm
							form={form}
							field={"barcode_price_hide"}
							name={"barcode_price_hide"}
							label={t("BarcodePriceHide")}
						/>
					</Box>
					...
					<Box>
						<InputCheckboxForm form={form} field={"sku_brand"} name={"sku_brand"} label={t("SKUBrand")} />
					</Box>
					<Box>
						<InputCheckboxForm form={form} field={"sku_grade"} name={"sku_grade"} label={t("SKUGrade")} />
					</Box>
					<Box>
						<InputCheckboxForm form={form} field={"sku_color"} name={"sku_color"} label={t("SKUColor")} />
					</Box>
					<Box>
						<InputCheckboxForm form={form} field={"sku_model"} name={"sku_model"} label={t("SKUModel")} />
					</Box>
					<Box>
						<InputCheckboxForm form={form} field={"sku_size"} name={"sku_size"} label={t("SKUSize")} />
					</Box>
				</Box>
				<Button id="ProductFormSubmit" type="submit" style={{ display: "none" }}>
					{t("Submit")}
				</Button>
			</form>
		</ScrollArea>
