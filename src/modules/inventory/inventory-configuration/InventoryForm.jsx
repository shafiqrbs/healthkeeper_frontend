...
import { Box, Grid, ScrollArea, Button, Text, Title } from "@mantine/core";
			...
			<form onSubmit={form.onSubmit(handleInventoryFormSubmit)}>
				<Box pt={"xs"} pl={"xs"} pb={"sm"}>
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("IsStockHistory")}
							field={"is_stock_history"}
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("IsPrintHeader")}
							field={"is_print_header"}
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("IsInvoiceTitle")}
							field={"is_invoice_title"}
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("PrintOutstanding")}
							field={"print_outstanding"}
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("IsPrintFooter")}
							field={"is_print_footer"}
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("InvoicePrintLogo")}
							field={"invoice_print_logo"}
				...
				<Button id="InventoryFormSubmit" type="submit" style={{ display: "none" }}>
					Submit
				</Button>
			</form>
		</ScrollArea>
