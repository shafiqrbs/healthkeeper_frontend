...
export default function AccountingForm({ height, module }) {
	...
	const { data: accountDropdownData } = useGlobalDropdownData({
		path: ACCOUNTING_DROPDOWNS.ACCOUNT.PATH,
		params: { "dropdown-type": ACCOUNTING_DROPDOWNS.ACCOUNT.TYPE },
		utility: ACCOUNTING_DROPDOWNS.ACCOUNT.UTILITY,
	});

	const { data: accountingLedgerDropdownData } = useGlobalDropdownData({
		path: ACCOUNTING_DROPDOWNS.ACCOUNT_LEDGER.PATH,
		params: { "dropdown-type": ACCOUNTING_DROPDOWNS.ACCOUNT_LEDGER.TYPE },
		utility: ACCOUNTING_DROPDOWNS.ACCOUNT_LEDGER.UTILITY,
	});

	const { data: voucherDropdownData } = useGlobalDropdownData({
		path: ACCOUNTING_DROPDOWNS.VOUCHER.PATH,
		params: { "dropdown-type": ACCOUNTING_DROPDOWNS.VOUCHER.TYPE },
