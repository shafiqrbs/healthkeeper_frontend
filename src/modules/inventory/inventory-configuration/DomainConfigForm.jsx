...
import { Box, Grid, Checkbox, ScrollArea, Button, Text, Title } from "@mantine/core";
...
import TextAreaGenericForm from "@components/form-builders/TextAreaGenericForm";
...
export default function DomainConfigForm() {
	...
	let currencyList = useGlobalDropdownData("currency");
	let countryList = useGlobalDropdownData("country");
	let businessModelList = useGlobalDropdownData("business_model");
			...
			<form onSubmit={form.onSubmit(handleInventoryFormSubmit)}>
				<Box pt={"xs"} pl={"xs"} pb={"sm"}>
					...
					<Box>
						<InputCheckboxForm
							form={form}
							label={t("IsBatchInvoice")}
							field={"is_batch_invoice"}
				...
				<Button id="DomainFormSubmit" type="submit" style={{ display: "none" }}>
					Submit
				</Button>
			</form>
		</ScrollArea>
