...
import AddProductDrawer from "../../inventory/sales/drawer-form/AddProductDrawer.js";
...
function _GenericRequisitionForm(props) {
	...
	return (
		<Box>
											...
											<Box>
												<Grid columns={12} gutter={{ base: 8 }}>
													...
													<Grid.Col span={4}>
														...
														<Text ta="right" mt={"8"}>
															{currencySymbol}{" "}
															{selectProductDetails ? selectProductDetails.sub_total : 0}
														</Text>
													</Grid.Col>
												</Grid>
											</Box>
			...
			{settingDrawer && (
				<SettingDrawer settingDrawer={settingDrawer} setSettingDrawer={setSettingDrawer} module={"sales"} />
			)}
			{productDrawer && (
				<AddProductDrawer
