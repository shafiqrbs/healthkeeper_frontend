...
function DomainUpdateForm() {
	...
	const entityEditData = useSelector((state) => state.crud.domain.entityEditData);
	const formLoading = useSelector((state) => state.crud.domain.formLoading);
	...
	const [moduleChecked, setModuleChecked] = useState(
		Array.isArray(entityEditData?.modules)
							...
							modals.openConfirmModal({
								...
								onConfirm: () => {
									...
									setTimeout(() => {
										...
										dispatch(
											setRefetchData({ module: "domain", refetching: true })
										);
											...
											>
												<Box pb={"md"}>
													...
													<Box mt={"8"}>
														<InputForm
															tooltip={t(
																"CompanyStoreNameValidateMessage"
															)}
													...
													<Box mt={"xs"}>
														<InputNumberForm
															tooltip={t(
																"AlternativeMobileValidateMessage"
															)}
