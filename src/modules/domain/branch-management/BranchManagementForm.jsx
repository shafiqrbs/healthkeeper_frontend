...
import { getIndexEntityData, storeEntityData } from "@/app/store/core/crudThunk.js";
...
export default function BranchManagementForm() {
	...
	const maxSwitchesInBox = Math.max(
		...domainsData.map((domain) => Math.max(domain?.prices?.length || 0, 5))
	);
																	...
																	<Checkbox
																		...
																		style={{
																			paddingLeft:
																				...
																				0
																					? "16px"
																					: "0px", // Apply left padding for the first column
