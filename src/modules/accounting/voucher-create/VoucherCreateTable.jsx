...
import { Group, Box, ActionIcon, Text, rem, Menu, Switch, Flex } from "@mantine/core";
	...
	return (
		<>
			...
			{voucherCrateViewDrawer && (
				<_VoucherCreateViewDrawer
					voucherCrateViewDrawer={voucherCrateViewDrawer}
					setVoucherCreateViewDrawer={setVoucherCreateViewDrawer}
				/>
			)}
		</>
	);
