												...
												<Box>
													<Box mt={"xs"}>
														<SelectForm
															...
															value={
																methodData
																	? String(methodData)
																	: entityEditData?.method_id
																	? String(entityEditData.method_id)
																	: null
															}
													...
													<Box mt={"xs"}>
														<SelectForm
															...
															value={
																authorisedData
																	? String(authorisedData)
																	: entityEditData?.authorised_mode_id
																	? String(entityEditData.authorised_mode_id)
																	: null
															}
														...
														<SelectForm
															...
															value={
																accountTypeData
																	...
																	: entityEditData?.account_mode_id
																	? String(entityEditData.account_mode_id)
																	: null
															}
													...
													<Box mt={"xs"}>
														...
														>
															<Image
																...
																alt="Logo"
																src={
																	"https://poshbackend.poskeeper.com/uploads/accounting/transaction-mode/" +
																	entityEditData?.path
																}
															/>
														</Flex>
