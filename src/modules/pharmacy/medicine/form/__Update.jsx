...
import {HOSPITAL_DATA_ROUTES, MASTER_DATA_ROUTES, PHARMACY_DATA_ROUTES} from "@/constants/routes";
...
export default function __Update({ module, form, close }) {
	...
	async function handleConfirmModal(values) {
		try {
			const value = {
				url: `${PHARMACY_DATA_ROUTES.API_ROUTES.MEDICINE.UPDATE}/${id}`,
				data: values,
				module,
			};
			...
			if (updateEntityData.rejected.match(resultAction)) {
				...
				setTimeout(() => {
					...
					navigate(PHARMACY_DATA_ROUTES.NAVIGATION_LINKS.MEDICINE.INDEX, { replace: true });
					setIndexData(null);
				}, 700);
			}
		} catch (error) {
