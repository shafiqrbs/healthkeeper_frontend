...
import AddCustomerDrawer from "../../inventory/sales/drawer-form/AddCustomerDrawer.js";
...
export default function Invoice(props) {
	...
	useEffect(() => {
		if (invoiceData) {
			...
			setSalesDueAmount(
				(invoiceData.sub_total || 0) - ((invoiceData.payment || 0) + (invoiceData.discount || 0))
			);
	...
	return (
		<>
			...
			>
				<Group gap={6} mb={4} preventGrowOverflow={false} grow align="flex-start" wrap="nowrap">
					<SelectForm
						pt={"8"}
						label=""
						tooltip={"SalesBy"}
					...
					>
						...
						<Group gap="10" pr={"sm"} align="center">
							...
							<Text fw={"bold"} fz={"sm"} c={"black"}>
								...
								{salesTotalAmount && salesTotalAmount ? salesTotalAmount.toFixed(2) : 0}
							</Text>
						</Group>
					</Group>
				</Box>
					...
					<Stack align="stretch" justify={"center"} mt={6} gap={4} pl={4} pr={2} mb={0}>
						...
						<Grid
							...
							style={{
								borderRadius: 4,
								border:
									form.errors.transaction_mode_id && !transactionModeId ? "1px solid red" : "none",
							}}
						>
								...
								<Grid.Col span={6} bg={"green"}>
									...
									>
										<TextInput
											...
											type="number"
											placeholder={
												isThisTableSplitPaymentActive ? t("SplitPaymentActive") : t("Amount")
											}
