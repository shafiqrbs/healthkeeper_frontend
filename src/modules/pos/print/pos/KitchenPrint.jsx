...
export default function KitchenPrint({ selectedProducts, setPrint, salesByUserName }) {
	...
	useEffect(() => {
		!effectRan.current && (handlePrint(), setPrint(false), (effectRan.current = true));
	}, []);
		...
		<div className={classes["pos-body"]} ref={componentRef}>
			...
			<main className={classes["body-main"]}>
				<h3 className={classes["main-title"]}>
					<span className={classes["main-title-span"]}>{selectedProducts.type}</span>
				</h3>
