...
import { Grid, Box, Text, Stack, Button, Flex, Title, Center, Container, Tooltip } from "@mantine/core";
	...
	const ReportTable = () => {
		switch (activeReport) {
			case REPORT_TYPES.INVENTORY:
				return <__InventoryTable dataLimit={dataLimit} enableTable={enableTable} setDataLimit={setDataLimit} />;
			case REPORT_TYPES.SALES:
				return <__SalesTable dataLimit={dataLimit} enableTable={enableTable} setDataLimit={setDataLimit} />;
			case REPORT_TYPES.PURCHASE:
				return <__PurchaseTable dataLimit={dataLimit} enableTable={enableTable} setDataLimit={setDataLimit} />;
			case REPORT_TYPES.ACCOUNTING:
				return (
					<__AccountingTable dataLimit={dataLimit} enableTable={enableTable} setDataLimit={setDataLimit} />
				);
			default:
				return null;
		}
