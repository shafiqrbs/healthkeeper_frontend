...
import { Button, rem, Grid, Box, ScrollArea, Tooltip, Group, Text, LoadingOverlay, Title, Flex } from "@mantine/core";
import { useTranslation } from "react-i18next";
import { IconCheck, IconDeviceFloppy, IconRestore, IconPencilBolt } from "@tabler/icons-react";
...
function SalesUpdateForm() {
	...
	let customerDropdown =
		customerDropdownData && customerDropdownData.length > 0
			...
			>
				...
				<Box m={"md"}>
					<Grid columns={24}>
						...
						<Grid.Col span={3}>
							<Shortcut form={form} FormSubmit={"VendorFormSubmit"} Name={"CompanyName"} />
						</Grid.Col>
					</Grid>
				</Box>
			</form>
