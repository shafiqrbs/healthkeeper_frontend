...
function SalesCardItems(props) {
	...
	return (
		<Table.Tr key={index}>
			...
			<Table.Td fz={"xs"} fw={"800"} style={{ textAlign: "right" }}>
					...
					<ActionIcon
						...
						onClick={() => {
							modals.openConfirmModal({
								...
								children: <Text size="sm">{t("DeleteDetails")}</Text>,
