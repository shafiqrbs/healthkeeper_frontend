...
import { IconFilter, IconEyeSearch, IconUserCircle, IconInfoCircle } from "@tabler/icons-react";
				...
				<Grid cols={2}>
					<Grid.Col span={8}>
						...
						<ScrollArea style={{ height: "500px" }}>
							{data && data.length > 0 && <MantineReactTable table={table} />}
						</ScrollArea>
					</Grid.Col>
