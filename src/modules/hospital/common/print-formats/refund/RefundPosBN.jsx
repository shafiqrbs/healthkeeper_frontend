...
const RefundPosBN = forwardRef(({ data, preview = false }, ref) => {
	console.log(data);
					...
					<Table withRowBorders={false} fz={10}>
						<Table.Tbody>
							...
							<Table.Tr>
								...
								<Table.Td align="right">
									<strong>{t("ApprovedBy")}:</strong> {patientInfo?.approved_by_name}
								</Table.Td>
							</Table.Tr>
							<Table.Tr>
								<Table.Td colSpan={2} align="center">
...
RefundPosBN.displayName = "RefundPosBN";

export default RefundPosBN;
