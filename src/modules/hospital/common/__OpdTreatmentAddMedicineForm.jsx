...
const templateModule = MODULES_CORE.TREATMENT_TEMPLATES;
const treatmentModule = MODULES_CORE.USER_TREATMENT;

export default function OpdTreatmentAddMedicineForm({ medicines, module, setMedicines }) {
	const {
		features,
		meals,
		dosages,
	...
	async function handleConfirmModal(values) {
		try {
			...
			if (storeEntityData.rejected.match(resultAction)) {
				...
				dispatch(setRefetchData({ module: templateModule, refetching: true }));
			}
		} catch (error) {
			console.error(error);
