...
import { Box, Text, Button, Stack, Select, Checkbox, Center, TextInput } from "@mantine/core";
								...
								<DataTable
									...
									columns={[
										...
										},
										{
											...
											render: (values) => (
												<>
													<Text fz="xs">{values.mode_name}</Text>
												</>
											),
										},
										{
											...
											render: (values) => (
												<>
													<Text fz="xs">{values.hms_particular_type_name}</Text>
												</>
											),
										},
										...
										},
										{
											...
											render: (item) => (
												<Checkbox
													...
													onChange={(val) =>
														handleFieldChange(item.id, "status", val.currentTarget.checked)
													}
												/>
											),
										},
