...
export default function __IssueMedicineDrawer({
    ...
    const handleDataTypeChange = (id, value = 0) => {
        ...
        const originalDaily = Number(
            medicineHistoryData.data.find((r) => r.id === id)?.daily_quantity || 0
        );
                                                ...
                                                <Table.Tr key={item.id}>
                                                    ...
                                                    <Table.Td>
                                                        <NumberInput
                                                            ...
                                                            value={submitFormData[item.id]?.quantity ?? Number(item.daily_quantity)}
                                                            clampBehavior="strict"
                                                            max={Number(item.daily_quantity)}
                                                            onChange={(val) =>
                                                                handleDataTypeChange(item.id, val)
                                                            }
                                                        />
                                                    </Table.Td>
                                                </Table.Tr>
