...
const useTransactionModeDropdownData = () => {
	...
	const transactionModelDropdownData = useSelector(
		(state) => state.accountingUtilitySlice.transactionModeData
	);
...
export default useTransactionModeDropdownData;
