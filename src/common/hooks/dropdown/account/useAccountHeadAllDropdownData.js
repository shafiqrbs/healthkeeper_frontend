...
import { coreSettingDropdown } from "@/app/store/core/utilitySlice.js";
...
export default function useAccountHeadDropdownData(reloadTrigger, dropdownType) {
	...
	const accountHeadDropdownData = useSelector(
		(state) => state.utilitySlice.accountHeadDropdownData
	);
