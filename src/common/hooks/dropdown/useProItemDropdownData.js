...
const useProItemDropdownData = () => {
	...
	const proItemDropdownData = useSelector(
		(state) => state.productionUtilitySlice.proItemDropdownData
	);
...
export default useProItemDropdownData;
