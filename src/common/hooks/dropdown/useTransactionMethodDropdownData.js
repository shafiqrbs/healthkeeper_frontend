...
const useTransactionMethodDropdownData = () => {
	...
	const transactionMethodDropdownData = useSelector(
		(state) => state.accountingUtilitySlice.transactionMethodData
	);
...
export default useTransactionMethodDropdownData;
