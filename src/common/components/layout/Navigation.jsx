...
import { Button, Flex, Text, Tooltip, ScrollArea, Box } from "@mantine/core";
...
export default function Navigation({ module = "base" }) {
	...
	const links = sideNavigationLinks[module];
	return (
		<>
			<ScrollArea h={height - 8} bg="white" type="never" className="border-radius">
				<Flex direction="column" px={4} py={15} gap={10}>
					{links.map((item, index) => (
						<Flex key={index} direction="column" align="center">
							...
							<Flex direction="column" align="center" c="black" mt={5}>
								<Text
									size="12px"
									c="black"
									ta="center"
